...
{% hint style="warning" %}
Disponible avec le `/vote-shop` -> [les-points-vote.md](../introduction/comment-voter/les-points-vote.md "mention")
{% endhint %}

<figure><img src="../.gitbook/assets/image (61).png" alt="" width="319"><figcaption></figcaption></figure>

{% hint style="warning" %}
Disponible dans caisse: **Epique** et **Légendaire**
{% endhint %}
...
<figure><img src="../.gitbook/assets/image (63).png" alt="" width="435"><figcaption></figcaption></figure>

{% hint style="warning" %}
Disponible dans caisse: **Légendaire**
{% endhint %}
